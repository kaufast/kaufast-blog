...
faq:
  - question: "¿Cuáles son las mayores multas del RGPD?"
    answer: "Las mayores multas del RGPD incluyen la penalización de 1,200 millones de euros a Meta por transferir datos de la UE a EE.UU., la multa de 746 millones de euros a Amazon por violaciones de consentimiento publicitario y la multa de 225 millones de euros a WhatsApp por fallas de transparencia. Desde 2018, las multas totales superan los 4,500 millones de euros."
...
Normalmente no es algo malintencionado. La mayoría de las empresas no se sientan a decidir violar el RGPD. Lo que ocurre es más sutil:
...
- Copian lo que hacen los competidores. "Si las demás empresas de nuestro sector lo hacen así, debe estar bien." Excepto que esas empresas también podrían estar incumpliendo — simplemente no las han descubierto todavía.
- Asumen que el consentimiento lo cubre todo. "El usuario hizo clic en 'aceptar' así que podemos hacer lo que queramos con sus datos." Así no funciona el consentimiento bajo el RGPD. Para nada.
...
La regla inventada del hospital: "Nuestro personal es profesional, solo accederán a los registros que necesiten." La respuesta de la Autoridad Holandesa de Protección de Datos: la confianza no es una medida de seguridad. Debes implementar controles de acceso basados en roles, registros de actividad y monitoreo.
...
Todas y cada una de estas multas comparten la misma causa raíz: la organización hizo suposiciones sobre lo que estaba permitido en lugar de verificar lo que la ley realmente exige.
...
Cómo lo abordamos nosotros:** Implementa **control de acceso basado en atributos (ABAC) que evalúa permisos dinámicamente según rol, departamento, nivel de sensibilidad de los datos y contexto — no asignaciones estáticas de roles que se degradan con el tiempo. Integra el aprovisionamiento de accesos con tu proveedor de identidad (Okta, Azure AD, Google Workspace) para que los permisos se actualicen automáticamente cuando alguien cambia de puesto o causa baja.

### 4. Ten un Plan de Respuesta ante Brechas

El RGPD te exige notificar las brechas calificadas a tu autoridad de control en un plazo de 72 horas. No puedes cumplir este plazo si no tienes un plan preparado antes de que ocurra la brecha.
