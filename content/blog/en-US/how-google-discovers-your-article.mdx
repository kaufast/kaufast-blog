...
featured: false
faq:
  - question: "How does Google find and index new content?"
    answer: "Google discovers content through three stages: crawling (following links and sitemaps to find pages), indexing (analyzing and storing the content), and ranking (ordering results by relevance). Submitting your sitemap in Google Search Console and building internal links speeds up discovery."
  - question: "Why is my page not showing up in Google search results?"
    answer: "Common reasons include: your page hasn't been crawled yet, it has a noindex tag, it returns a server error, it has thin or duplicate content, or it lacks internal links. Check Google Search Console's URL Inspection tool to diagnose the specific issue."
  - question: "How long does it take for Google to index a new page?"
    answer: "Indexing can take anywhere from a few hours to several weeks. Pages on established sites with strong internal linking and submitted sitemaps get indexed faster. New sites or pages without inbound links may take longer. Requesting indexing via Search Console can accelerate the process."
---

Google has indexed roughly 400 billion web pages. Learn more about [proven SEO strategies](/en-US/insights/seo-strategies-that-actually-work). That sounds impressive until you realize it's a fraction of the internet. Google discovers pages and then decides — within seconds — whether they're worth showing to anyone. Most pages never make the cut. Not because they're bad, but because nobody told Google they exist, or the page had a technical problem that kept it out of the index.

Understanding how search engines work isn't optional if you want your content to be found. Learn more about [why bad SEO damages growth](/en-US/insights/bad-seo-is-worse-than-no-seo). It's not complicated either. There are three stages: crawling (finding your page), indexing (deciding to store it), and ranking (deciding where it shows up). Get all three right and you're visible. Get any of them wrong and you're shouting into the void.

## Stage 1: Crawling — How Search Engines Find Your Pages

Google, Bing, and other search engines use automated programs called crawlers (or spiders) to navigate the web. Learn more about [SEO as an ongoing process](/en-US/insights/why-seo-is-never-done). Googlebot visits known pages, follows every link it finds, and discovers new content. It's like a librarian walking through a building, opening every door, and cataloguing what's inside.

Here's what most people don't realize: Googlebot doesn't visit your site once. It visits constantly. Large sites get crawled daily. Small sites might get visited every few days or weeks. The frequency depends on how often you publish new content, how many external sites link to you, and whether your site has a clean technical foundation.
...
- No internal links pointing to the page. If a page exists on your site but nothing links to it, crawlers literally can't find it. These are called orphan pages — 25% of pages on the average website have zero internal links pointing to them.
...
- Thin content. Pages with fewer than 300 words of unique text are frequently skipped. Pages need to provide substantial, unique value to earn indexation.
- Duplicate content. If your page says essentially the same thing as another page on your site (or someone else's), Google picks one and ignores the rest. An estimated 28% of the web is duplicate content that never appears in search results.
...
- Freshness. For topics where information changes (pricing, statistics, best-of lists), Google heavily favors recently updated content. Pages updated within the last 12 months rank significantly higher for time-sensitive queries.
...
- Cited sources and verifiable claims — Perplexity specifically prioritizes content it can cite
