...
faq:
  ...
  - question: "Do small businesses need to comply with GDPR?"
    answer: "Yes. GDPR applies to any organization that processes personal data of EU residents, regardless of company size. Small businesses face the same rules — and enforcement is increasing against smaller companies. Fines can reach up to €20 million or 4% of annual global turnover, whichever is higher."
...
Between 2018 and 2026, European Data Protection Authorities issued over €4.5 billion in GDPR fines. The pattern behind nearly every enforcement action is identical: the organization built internal data-handling practices based on assumptions rather than the regulation's actual requirements under Articles 5, 6, and 9.
...
- They think small businesses are exempt. The GDPR applies to any organization that processes personal data of EU residents. Period. There is no revenue threshold. There is no employee count minimum. A one-person company with a mailing list is subject to the GDPR.
...
€35.3 million for notes on a shared drive.** The violation centered on **Articles 5(1)(a), 5(1)(c), and 6 — lawfulness, fairness, data minimization, and lack of legal basis for processing special category data under Article 9.
...
Dozens of hospital employees accessed the medical records of a Dutch celebrity without any legitimate reason. The hospital had no adequate access controls to prevent or detect unauthorized access to patient files.
...
This was one of the very first GDPR fines issued. The hospital had 985 active "doctor" profiles while employing only 296 doctors. Social workers, technicians, and administrative staff all had access to patient records through doctor-level permissions.

The hospital's invented rule: "We'll sort out the permissions eventually." The Portuguese DPA (CNPD) found that the hospital had violated the principles of data integrity, confidentiality, and data minimization.
...
You don't need to be a hospital or a tech giant to get fined. The vast majority of GDPR enforcement actions target ordinary processing of ordinary personal data — email addresses, phone numbers, purchase histories, browsing behavior.

### Austrian Post — €18 Million

Austrian Post created political affinity profiles for millions of Austrian citizens by analyzing their demographic data, address, and purchasing behavior. They then sold these profiles to political parties for targeted campaigning.

Their invented rule: "It's statistical analysis, not personal data processing." The Austrian DPA disagreed. Inferring political opinions from behavioral data is processing special category data. You can't do that without explicit consent, and certainly not to sell to political parties.

### Vodafone Spain — €8.15 Million (Multiple Decisions)

Vodafone Spain received multiple fines totaling over €8 million for sending marketing communications without consent, continuing to call people who had opted out, and in one notable case, setting up a phone contract in the name of someone who wasn't even a Vodafone customer.
...
Every single one of these fines shares the same root cause: the organization made assumptions about what was allowed instead of checking what the law actually requires.
...
- "Our industry does it this way" (industry practice isn't a legal defense)
- "We didn't know" (ignorance isn't a defense under the GDPR)
...
Before anything else, you need to know what personal data you process, why, and on what legal basis. This is Article 30 — the Record of Processing Activities (ROPA). Every organization needs one.
...
The alternative — making up your own rules and hoping nobody notices — has a documented track record: billion-euro fines, reputational damage, and businesses that wish they'd just done it properly from the start.
