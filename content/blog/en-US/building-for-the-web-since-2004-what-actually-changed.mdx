...
featured: false
faq:
  - question: "What has actually changed in web development over 20 years?"
    answer: "The tools have changed dramatically — from PHP and jQuery to React, Next.js, and AI agents — but the fundamentals haven't. Shipping working software, understanding the problem before coding, and maintaining what you build still matter more than any framework choice."
  - question: "Is AI the biggest change in web development history?"
    answer: "Yes. Unlike previous shifts (mobile, cloud, frameworks), AI fundamentally changes what software can do — it understands and responds to natural language. Previous changes were about how we build; AI changes what we can build. It's the first real paradigm shift in 20 years of web development."
  - question: "What is the most important lesson from 20 years of building software?"
    answer: "Maintenance is the real product. Writing code is the easy part; keeping it running, updated, and useful for years is what separates successful projects from abandoned ones. Most software investment goes into maintenance, not initial development."
---

I wrote my first line of production code in 2004. Learn more about [website speed impact on revenue](/en-US/insights/web-performance-revenue-case-studies). PHP, MySQL, a shared hosting server that went down every other weekend. The website I built looked terrible by today's standards. But it worked. People used it. It solved a real problem. That's still the only metric that matters.

Over the past two decades, I've watched every major wave of web technology come and go. Learn more about [performance and search rankings](/en-US/insights/why-site-speed-affects-seo). Web 2.0. The mobile revolution. Responsive design. Single-page apps. The cloud. Microservices. Blockchain (remember that?). And now, AI. Some of these changed everything. Most of them changed less than people thought at the time. Here's what I've actually learned.

## The Tools Changed. The Job Didn't.

In 2004, I built web applications with PHP and jQuery. For more insights, see [website speed](/en-US/insights/why-site-speed-affects-seo). In 2026, I build them with React, Next.js, and Node.js. The syntax is different. The developer experience is better. But the fundamental job is identical: take a business problem, turn it into working software, put it in front of real users, and keep it running.
...
I've been skeptical of most tech waves. I was right about blockchain. I was wrong about mobile (underestimated it massively). AI? This one is real. But not because of the reasons most people are excited about.
