...
faq:
  - question: "How does Google find and index new content?"
    answer: "Google discovers content through three stages: crawling (following links and sitemaps to find pages), indexing (analysing and storing the content), and ranking (ordering results by relevance). Submitting your sitemap in Google Search Console and building internal links speeds up discovery."
...
Google has indexed roughly 400 billion web pages. Learn more about [proven SEO strategies](/en-GB/insights/seo-strategies-that-actually-work). That sounds impressive until you realise it's a fraction of the internet. Google discovers pages and then decides — within seconds — whether they're worth showing to anyone. Most pages never make the cut. Not because they're bad, but because nobody told Google they exist, or the page had a technical problem that kept it out of the index.

Understanding how search engines work isn't optional if you want your content to be found. Learn more about [why bad SEO damages growth](/en-GB/insights/bad-seo-is-worse-than-no-seo). It's not complicated either. There are three stages: crawling (finding your page), indexing (deciding to store it), and ranking (deciding where it shows up). Get all three right and you're visible. Get any of them wrong and you're shouting into the void.

## Stage 1: Crawling — How Search Engines Find Your Pages

Google, Bing, and other search engines use automated programs called crawlers (or spiders) to navigate the web. Learn more about [SEO as an ongoing process](/en-GB/insights/why-seo-is-never-done). Googlebot visits known pages, follows every link it finds, and discovers new content. It's like a librarian walking through a building, opening every door, and cataloguing what's inside.
