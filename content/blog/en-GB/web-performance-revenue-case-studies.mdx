---
title: "Site Speed & Revenue: Data From 6 Companies"
h1: "Every 100ms Costs You Money: What Amazon, Vodafone & Google Learned About Site Speed"
headline: "Vodafone gained 8% more sales from a 31% LCP fix. Google proved 0.1s faster means 8.4% more conversions across 30 million sessions. Here is the data behind performance-driven revenue."
date: "21 May 2026"
lastmod: "21 May 2026"
...
faq:
  - question: "Does page speed directly affect search engine rankings?"
    answer: "Yes. Core Web Vitals (LCP, INP, and CLS) are explicit algorithmic ranking signals. Slow load speeds also cause users to bounce back to search results, signalling to AI and traditional search systems that your page failed to satisfy the user's intent efficiently."
  - question: "What is a good baseline target for Interaction to Next Paint (INP)?"
    answer: "An INP score under 200 milliseconds indicates good page responsiveness. Scores between 200ms and 500ms need substantial improvement, while anything over 500ms severely degrades user experience and signals technical debt to search engine crawlers."
  - question: "Why does my site score well on PageSpeed but conversions remain low?"
    answer: "A high PageSpeed score means your technical foundation is fast, but it cannot fix broken user experience, poor pricing structures, or weak copywriting. Performance optimises the delivery of your value proposition — it cannot replace the value proposition itself."
  - question: "How much revenue does improving Largest Contentful Paint generate?"
    answer: "Vodafone's controlled A/B test showed a 31% LCP improvement led to 8% more sales, 15% better lead-to-visit rate, and 11% better cart-to-visit rate. Google-commissioned Deloitte research across 30 million sessions found a 0.1-second improvement produces 8.4% more retail conversions."
---
...
Site speed is no longer an isolated technical box for your engineering team to check. It is the **direct foundation of your conversion rate optimisation and search visibility strategy.** When your pages load slowly, your users do not wait — they bounce straight back to the search engine, sending signals that AI-driven search platforms track instantly.

Here is exactly how six global enterprises quantified the financial impact of web performance, and how you can use their data to protect your baseline.
...
That last number stops meetings. A 21.6% increase in form submissions from a speed improvement you cannot consciously perceive. The explanation is cumulative micro-friction: every additional frame of delay introduces a probability of distraction, tab-switching, or abandonment. At scale, those probabilities compound into lost revenue.
...
**Cloudflare Speed Brain:** Speculative prefetching using machine learning reduces LCP by **45% on successful prefetches** — roughly 0.88 to 1.1 seconds saved per navigation, with **94% prefetch accuracy** on tested sites.
...
The pattern is universal. There is no industry, geography, or company size where faster pages did not produce measurable business improvement.
...
**2. The Asset Pipeline (Next-Gen Formats):** Force the deprecation of legacy JPEGs and PNGs. Implement automated middleware to convert assets to WebP or AVIF dynamically based on client capabilities. Shinola automated this in 2024 and cut page weight by 50%. Cloudflare Polish reduces image sizes by 35% on average. Every uncompressed hero image is a conversion you never made.
