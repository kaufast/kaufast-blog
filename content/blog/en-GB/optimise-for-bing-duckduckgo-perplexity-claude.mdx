...
featured: true
faq:
  - question: "Should I optimise for search engines other than Google?"
  ...
  - question: "How do I optimise my website for Perplexity and Claude?"
    answer: "For Perplexity, focus on original research, cited statistics, and content depth — it always cites sources and favours authoritative content. For Claude, ensure your entire website tells a consistent story with real case studies and specific details. Both reward structured data and expert attribution."
...
Here's a number that should change how you think about search: Google's share of the search market dropped from 93% to 89.7% in 2025, according to StatCounter. Learn more about [check your AI visibility](/en-GB/insights/is-your-business-visible-to-chatgpt-how-to-check). That's the fastest decline in Google's history. Where did those users go? Bing, DuckDuckGo, Perplexity, Claude, and Gemini.

You might think: 10% is nothing. Learn more about [how AI changes discovery](/en-GB/insights/how-ai-is-changing-how-people-find-businesses). But 10% of 8.5 billion daily searches is 850 million searches per day happening outside Google. That's more than the entire search market of 2005. And these aren't random users — they're often higher-value: privacy-conscious professionals on DuckDuckGo, power users on Perplexity, enterprise workers using Bing through Microsoft 365, and early adopters asking Claude for recommendations.

Most businesses optimise exclusively for Google. Learn more about [the rise of SEO-geo](/en-GB/insights/from-seo-to-seo-geo-what-changed-in-2026). Which means on every other platform, competition is dramatically lower. The same keyword that costs you €8/click on Google Ads might have zero competition on Bing. The same question that returns 10 competitors on Google might return only 2 on Perplexity — and you could be one of them.
...
For a real example, see how *[Echoflicks](https://echoflicks.com)* achieved citations across ChatGPT, Perplexity, and Gemini in [just 7 days](/en-GB/insights/echoflicks-ai-writes-about-us-7-days) using the cross-platform strategy described in this article.
